...
public class HashMap <K, V> {
    ...
    public String toString() {
        ...
        for(int i=0; i < buckets.length; i++) {
            ...
            if(bucket != null) {
                stringBuilder.append(bucket.head.value.key);
                stringBuilder.append(": ");
                stringBuilder.append(bucket.head.value.value);
                stringBuilder.append("\n");
                if(bucket.head.next != null) {
                    Bucket.Node current = bucket.head.next;
                    while(current != null) {
                        stringBuilder.append(current.value.key);
                        stringBuilder.append(": ");
                        stringBuilder.append(current.value.value);
                        stringBuilder.append("\n");
